...
function pageLoad(){
    ...
    document.getElementById("qry_month_id").value = last_month
        .Format('YYYYMM');
...
//查询
function getSearch() {
    searchSubmit.oper_type.value = "QUERY_RANK";
    reportProcessSearch('searchSubmit', 'qryBonusRankIframe.jsf', "<%=path%>", 'isQueryOk');
}

//导出
function exportOut() {
    searchSubmit.oper_type.value = "QUERY_RANK";
    exportExcel('searchSubmit', 'qryBonusRankIframe.jsf?1=1', "<%=path%>", 'isExportQryOk');
}
        ...
        <form target="InfoPage" id="searchSubmit" name="searchSubmit"
            ...
            <tr>
                <td valign="top"><table width="100%" height="100%"
                        ...
                        <%
                            /*** WEB开发 beginning ***/
                            String iframPage = "qryBonusRankIframe.jsf";
                            String selectedPage = "";

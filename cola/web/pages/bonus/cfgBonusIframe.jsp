            ...
            if ((rowList != null) && (rowList.size() > 0)) {
        				for (int i = 0; i < rowList.size(); i++) {
        					if (i == 0) {
        						...
        						out.print("onClick=\"$('#table_list').find('.selected').removeClass('selected');$(this).addClass('selected');parent.selectRow('"
        								+ listData.get(0).toString().trim()
                                        + "','"
                                        + listData.get(1).toString().trim()
        								+ "','"
        								+ listData.get(3).toString().trim()
        								+ "','"
        								+ listData.get(6).toString().trim()
        								+ "','"
        								+ listData.get(7).toString().trim()
        								+ "','"
        								+ listData.get(8).toString().trim() + "');\">");
